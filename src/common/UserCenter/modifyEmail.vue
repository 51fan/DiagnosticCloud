            ...
            <v-stepper-items>
              <v-stepper-content step="1">
                <div class="md-layout-item md-size-100" style="text-align:center;margin: 20px;">
                  <span style="font-size: x-large;">修改邮箱前我们需要验证您的身份</span>
                </div>
              ...
              <v-stepper-content step="2">
                <div class="md-layout-item md-size-100" style="text-align:center;margin: 20px;">
                  <span style="font-size: x-large;">设置新邮箱</span>
                </div>
                  ...
                  <v-flex xl6 lg6 md10 sm12 xs12 style="padding: 0 6% 0 6%;">
                    <div>
                      <div class="md-layout-item md-size-100" style="margin: 5% 0;">
                          ...
                          <div class="inputError">
                              <span v-if="showEmailErr">{{emailErrText}}</span>
                          </div>
                      </div>
              ...
              <v-stepper-content step="3">
                <div class="md-layout-item md-size-100" style="text-align:center;margin: 20px;">
                   <img src="/static/imgs/ic_hint_finish.png">
                    ...
                    <h2>您的账号关联的邮箱已经修改为<span style="color:green;margin-bottom:30px;">{{NewEmail}}</span></h2>
    ...
    inputFunc(index) {
      switch (index) {
        ...
        case 2:
          ...
          if (!this.isEmail(this.NewEmail)) {
            this.showEmailErr = true;
            this.emailErrText = "邮箱格式不对";
          }
          break;
        case 3:
          break;
